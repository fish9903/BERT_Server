...
class KcBERT():
    def __init__(self):
        ...
        self.model.load_state_dict(torch.load('AI_models\models\KcBERT-emotions-model_state_dict3.pt',  map_location=torch.device('cpu')))  # state_dict를 불러 온 후, 기존 모델에 저장
    ...
    #predict("하.... 이 놈의 나라 노인네들은 또 의병이 나라 지키기를 원하는 건가??? 정녕 니 후손들이 통일된 민족, 좋은 나라, 공정한 나라에서 사는 게 그렇게 싫더냐? 미친 노인네들 어휴...", end='')
